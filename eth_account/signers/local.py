...
class LocalAccount(BaseAccount):
    ...
    def signTransactionv2(self, transaction_dict, signing_data):
        warnings.warn(
            "signTransaction is deprecated in favor of sign_transaction",
            category=DeprecationWarning,
        )
        return self.sign_transaction_v2(transaction_dict, signing_data)
    ...
    def sign_transaction_v2(self, transaction_dict, signing_data):
        return self._publicapi.sign_transaction(transaction_dict, self.key, signing_data)
