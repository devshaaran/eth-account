...
class Account(object):
    ...
    @combomethod
    def sign_transaction(self, transaction_dict, private_key, signing_data=None):
        """
        ...
        if signing_data == None:
            ...
            (
                ...
                s,
                encoded_transaction,
            ) = sign_transaction_dict_v2(account._key_obj, sanitized_transaction, signing_data)
            transaction_hash = keccak(encoded_transaction)
